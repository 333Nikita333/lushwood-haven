...
const Services: FC = () => {
  ...
  const getRoomsInfo = async () => {
    ...
    if (data) {
      setRooms(data);
      console.log('Services page, rooms', data);
    }
  };
  ...
  const getArrayRoomType = (roomType: string): Room[] => {
  ...
  return (
    <WrapperOuter>
      <ServiceBgParallaxContainer options={topPage}>
        <ServiceRoomList roomList={getArrayRoomType('Standard')} />
      ...
      <ServiceBgParallaxContainer options={middlePage}>
        <ServiceRoomList roomList={getArrayRoomType('Family')} />
      </ServiceBgParallaxContainer>
      ...
      <ServiceBgParallaxContainer options={bottomPage}>
        <ServiceRoomList roomList={getArrayRoomType('Suite')} />
      </ServiceBgParallaxContainer>
    </WrapperOuter>
  );
};
